...
const ordersSortFunctions: Record<string, (a: any, b: any) => number> = {
	...
	[t('Average units ordered Descending')]: (a, b) => b.average_units_ordered - a.average_units_ordered,
	[t('Average units ordered Ascending')]: (a, b) => a.average_units_ordered - b.average_units_ordered,
	...
	} = useAnalyticsData(data.ordersAnalyticsTable, ordersSortFunctions);
