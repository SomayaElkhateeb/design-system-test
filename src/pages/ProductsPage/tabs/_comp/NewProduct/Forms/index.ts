// Schema
export { productDescriptionAndSpecificationsRawSchema } from './DescriptionAndSpecifications/utils';
export { productPricingSchema } from './Pricing/utils';
export { productInventoryBranchesSchema } from './Stock/utils';
...
export { productBasicInfoSchema } from './BasicInfo/utils';

// DefaultValues
export { productDescriptionAndSpecificationsDefaultValues } from './DescriptionAndSpecifications/utils';
export { productPricingDefaultValues } from './Pricing/utils';
export { productInventoryBranchesDefaultValues } from './Stock/utils';
...
export { productBasicInfoDefaultValues } from './BasicInfo/utils';
