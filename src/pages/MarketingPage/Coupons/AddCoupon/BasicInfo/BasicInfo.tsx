...
// 	const [selectedOptionType, setSelectedOptionType] = useState<string>(''); // Define state and its setter function
// 	const [selectedOptionApply, setSelectedOptionApply] = useState<string>(''); // Define state and its setter function
...
// 					<InputRow label='coupon code' ref={ref} onChange={handleInputChange} />
// 				</div>
// 			</div>
...
// 					setSelected={(option: string) => setSelectedOptionType(option)} // Pass setSelectedOption as a callback
// 				/>
...
// 					setSelected={(option: string) => setSelectedOptionApply(option)} // Pass setSelectedOption as a callback
// 				/>
