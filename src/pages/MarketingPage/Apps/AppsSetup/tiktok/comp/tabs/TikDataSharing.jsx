...
const TikDataSharing = ({ data }) => {
	...
	return (
		<div>
			...
			<div className='my-6'>
				<CheckBox label='Activate data sharing' checked={isChecked} handleOnChange={handleCheckBoxChange} />
			</div>
				...
				{isChecked && (
					<div className='flex flex-col w-1/3 space-y-3 '>
						<InputRow
							...
							handleOnChange={(value) => setState({ ...state, inputState: { ...state.inputState, value } })}
						/>
					</div>
				)}
