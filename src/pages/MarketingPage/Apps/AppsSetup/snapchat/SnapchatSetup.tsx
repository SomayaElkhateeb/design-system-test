...
import { getSnapchatSetup, SnapchatSetupData } from './_comp/getSnapchatSetup';

interface Props {
	platform: string;
}

const SnapchatSetup: React.FC<Props> = ({ platform }) => {
		...
		<section className='w-full p-5'>
			<div className='w-2/5 m-auto'>
				...
				<div className='flex justify-end mt-8 space-x-3'>
					<Button variant='secondary' onClick={() => navigate('/apps/snapchat')}>
						Discard
					</Button>
