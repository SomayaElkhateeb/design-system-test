...
import { StatusCheckBox } from "src/app/components/shared";
import { SelectButtons } from "..";
import { DiscountMinimunRequirements } from "src/app/utils/constants";
...
const MinimumRequirements = () => {
  ...
  return (
    <div className="bg-white w-full border border-constrained rounded-md p-[18px]">
      ...
      {showSelectButtons && <div className="pt-[18px]">  <SelectButtons data={DiscountMinimunRequirements} /> </div>}
    </div>
  );
};
