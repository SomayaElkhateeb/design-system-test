export const english = {
    ...
    Item: "Item",
    Qty: "Qty",
    "Customer Addresse": "Customer Addresse",
    ...
    "change category visibility to customers":
        "change category visibility to customers",
    edit: "edit",
    Name: "Name",
    Status: "Status",
    ...
    Price: "Price",
    Addons: "Addons",
    "Make more options for your customers":
        "Make more options for your customers",
    Addon: "Addon",
    ...
    "change Food visibility to customers":
        "change Food visibility to customers",
    Food: "Food",
    "Enter Three fields of name And Describtion":
        "Enter Three fields of name And Describtion",
