...
export const arabic = {
	...
	'TikTok Business Center Account': 'حساب مركز الأعمال TikTok',
	...
	'Allow Dookan to create account': 'اسمح لـ Dookan بإنشاء حساب',
	Create: 'انشاء',
	'Approve access to your TikTok Ads Manager account':
		'قم بالموافقة على الوصول إلى حساب مدير الاعلانات TikTok  الخاص بك',
	"In order to connect to this Business Center account, you'll need to approve admin access to the connected TikTok Ads Manager account.":
		'للاتصال بحساب مركز الأعمال هذا، ستحتاج إلى الموافقة على وصول المسؤول إلى حساب مدير اعلانات TikTok  المتصل.',
	Proceed: 'يتابع',
	...
	'You can Recync anytime with TikTok Catalog.':
		'يمكنك إعادة المزامنة في أي وقت باستخدام كتالوج TikTok.',
	'Yes, Disable': 'نعم تعطيل',
	'TikTok sales': 'مبيعات تيك توك',
	'Manage your TikTok features': 'إدارة ميزات TikTok الخاصة بك',
	'Marketing Catalog': '',
	'Set up now': '',
	'Snapchat sales': '',
	'Manage your Snapchat features': '',
	'Snapchat Marketing': '',
