...
export const arabic = {
	...
	'Add manually': 'الإضافة يدويا',
	'Use a map': 'استخدم الخريطة',
	'Opens at': 'يفتح في',
	'Closes at': 'يغلق عند',
	Closed: 'مغلق',
	'Add More Hours': 'إضافة المزيد من الساعات',
	'Delete Hours': 'حذف الساعات',
	Sun: 'الأحد',
	Mon: 'الاثنين',
	Tue: 'الثلاثاء',
	Wed: 'الأربعاء',
	...
	'Third party payment providers': 'مقدمو خدمات الدفع من الجهات الخارجية',
	'Providers that enable you to accept payment methods at a rate set by the third-party. An additional fee will apply to new orders once you select a plan.':
		'المزودون الذين يمكّنونك من قبول طرق الدفع بسعر تحدده الجهة الخارجية. سيتم تطبيق رسوم إضافية على الطلبات الجديدة بمجرد  اختيار خطة.',
	'Compare over 8 different payment gateway providers and pick the one that suits your needs.':
		'قارن بين أكثر من 8 من موفري بوابات دفع مختلفين واختر الذي يناسب احتياجاتك',
	'Accept payments using our plugin': 'استقبل المدفوعات باستخدام إضافتنا',
	'Accept payments on your store using the': 'قبول المدفوعات في متجرك باستخدام إضافة',
	'plugin, it provide you with International and local payment methods':
		'حيث توفر لك وسائل دفع دولية ومحلية',
	'Supported methods with fees': 'الطرق المدعومة مع الرسوم',
	'Supported banks': 'البنوك المدعومة',
	'Setup Dookan pay': 'تثبيت دوكان باي',
	'Other methods': 'طرق دفع أخرى',
	'Payments that are processed outside your online store. When a customer makes a manual payment, you need to approve their order before fulfilling.':
		'المدفوعات التي تتم خارج متجر الانترنت الخاص بك. عندما يقوم أحد العملاء بعملية دفع يدوية، يتعين عليك الموافقة على طلبه قبل إتمامه.',
	...
	'Methods transactions': 'طرق الدفع',
	Banks: 'البنوك',
	Setup: 'تثبيت',
	'Account number must be a positive number': 'رقم الحساب يجب أن يكون رقمًا إيجابيًا',
	'Account name cannot be empty': 'اسم الحساب لا يمكن أن يكون فارغًا',
	'Bank name cannot be empty': 'اسم البنك لا يمكن أن يكون فارغًا',
	'IBAN cannot be empty': 'لا يمكن أن يكون رقم IBAN فارغًا',
	'Instructions cannot be empty': 'لا يمكن أن تكون التعليمات فارغة',
	'Order items Account number must be a positive number': 'رقم الطلب يجب أن يكون رقمًا إيجابيًا',
	'Price number must be a positive number': 'سعر الرقم يجب أن يكون رقمًا إيجابيًا',
	'Account details': 'تفاصيل الحساب',
	'Fill in your account details, for customers to pay through':
		'املأ تفاصيل حسابك، ليتمكن العملاء من الدفع من خلالها',
	'Account number': 'رقم الحساب',
	'Account name': 'اسم الحساب',
	'Bank name': 'اسم البنك',
	'Select option': 'حدد خيارًا',
	'Additional details & instructions': 'تفاصيل إضافية وتعليمات',
	...
	'you’ll need this If you want this method to activate with certain conditions, otherwise keep defaults':
		'ستحتاج هذا إذا كنت ترغب في تنشيط هذه الطريقة بشروط معينة، وإلا فاحتفظ بالقيم الافتراضية',
	'Price is more than': 'السعر أكثر من',
	'Order items are more than': 'عناصر الطلب أكثر من',
