...
// get cart rule Show
export const getCartRuleShow = createAsyncThunk(
	'cartRuleShow/getCartRuleShow',
	(payload: string) => PublicRequest.getData(`merchant/marketing/promotions/cart-rules/${payload}`), 
);

// create CartRule
export const postCartRule = createAsyncThunk(
	"cartRule/postCartRule",
	(payload: any) =>
...
// update cart rule
export const putCartRule = createAsyncThunk(
	"putCartRule/putCartRule",
	(payload: any) =>
