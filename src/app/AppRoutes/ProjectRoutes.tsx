...
// 		return isSubdomain && token ? <Outlet /> : <Navigate to='/login' />;
// 	};
// 	const PrivateRoutesLoginPage = () => {
// 		// return !token ? <Outlet /> : <Navigate to='/home' />;
// 		return isMainDomain && !token ? <Outlet /> : <Navigate to='/home' />;
// 	};
...
const ProjectRoutes = () => {
	...
	const PrivateRoutesProject = () => {
		if(isLocalHost && token) return <Outlet />
		return isSubdomain && authToken  ? <Outlet /> : <Navigate to='/login' />;
	};
	const PrivateRoutesLoginPage = () => {
		if(isLocalHost) return <Outlet />
