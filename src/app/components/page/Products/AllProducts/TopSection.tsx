...
export default function TopSection({ verticalCard, setVerticalCard }: { verticalCard: boolean, setVerticalCard: (e: boolean) => void }) {
    ...
    const ActionsMenus = [
        ...
        { id: nanoid(), text: "Export products", icon: <SiMicrosoftexcel /> },
        { id: nanoid(), text: "Import products", icon: <FiUploadCloud /> },
    ...
    return (
        <div className="flex-row-global justify-between">
            ...
            >
                <div style={{ boxShadow: "0px 10px 16px 0px #0000000D" }} className="py-[.8rem] px-[.6rem] w-[20rem] h-[24rem] rounded-[.4rem] bg-white">
                                ...
                                <div className="flex flex-col gap-[.2rem] cursor-pointer">
                                    <div className="flex-row-global gap-[.4rem]">
                                        ...
                                        {e.shipping &&
                                            ...
                                            <img src={getImageUrl(`padges/shipped.svg`)} alt='status' />
                                        }
                                    </div>
