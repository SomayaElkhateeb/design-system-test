 ...
 * @param {import("react").Component} [props.icon] - Optional icon component to display with each chip
 */
 ...
 * @param {import("react").Component} [props.icon] - Optional icon component to display with the chip
